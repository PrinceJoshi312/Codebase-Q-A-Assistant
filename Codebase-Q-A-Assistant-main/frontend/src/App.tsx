...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-[#050505] text-slate-300 overflow-hidden font-sans selection:bg-indigo-500/30">
      ...
      <aside className="w-20 lg:w-72 bg-[#0a0a0a] border-r border-white/5 flex flex-col z-30 transition-all duration-300">
        <div className="p-6 flex items-center gap-3">
          ...
          <span className="font-black text-xl tracking-tighter text-white hidden lg:block uppercase">Neural <span className="text-indigo-500">Assistant</span></span>
        </div>
      ...
      <main className="flex-1 flex flex-col relative bg-[#050505]">
        ...
        {/* Header Bar */}
        <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-[#050505]/80 backdrop-blur-xl z-10">
